...
| D-003 | Stylelint directive comments (`stylelint-disable*`) | Not part of minimal config/runtime model for v1 | Teams cannot port suppression comments directly | v1.5 | TBD |
...
| D-007 | Rich include/exclude glob config model | v1 config remains intentionally minimal | Some monorepo/path workflows need CLI-level wrappers | v1.5 | TBD |
